...
5. `git checkout -B upstream-stable 0.10.0` Overwrite the latest stable into upstream-stable branch.
...
11. `grunt build:dropdown:modal:tooltip:progressbar:tabs:timepicker:typeahead:collapse:buttons:popover` Build the modules which you want. *Please update this line, if you add other module, people will copy/paste this.*
